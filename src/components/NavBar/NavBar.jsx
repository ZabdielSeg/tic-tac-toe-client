                ...
                <>
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                ...
                                <div className="hidden sm:ml-6 sm:block">
                                    <div className="flex space-x-4">
                                            <p className='font-mono text-yellow-100 px-3 py-2 text-sm font-medium'>
                                                Tic - tac - toe
                                            </p>
                                            <p className='font-mono text-emerald-500 px-3 py-2 text-sm font-medium'>
                            ...
                            <p className='bg-gray-800 p-1 text-gray-400 text-sm' >Total wins: {userData?.winsCounter || 0}</p>
